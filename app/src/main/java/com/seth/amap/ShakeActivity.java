...
public class ShakeActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private RelativeLayout RL_begin_shake, RL_Finaly_shake, RL_middle_shake;
    ...
    private void initView() {
        ...
        RL_begin_shake = findViewById(R.id.RL_begin_shake);
        RL_Finaly_shake = findViewById(R.id.RL_Finaly_shake);
        RL_middle_shake = findViewById(R.id.RL_middle_shake);
        //默认
...
//                            network();
    ...
    public void network() {
        Call<ResponseBody> call = HttpRequest.Shake(new NearByBeen(
                "Aes89347IudRR", 116.4612, 39.9212, 1));
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                Toast.makeText(ShakeActivity.this, "请检查您的网络环境", Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case START_SHAKE:
                    ...
                    //发出提示音
                    mActivity.RL_begin_shake.setVisibility(View.GONE);
                    ...
                    mActivity.RL_middle_shake.setVisibility(View.VISIBLE);
                    mActivity.RL_Finaly_shake.setVisibility(View.GONE);
...
//                    mActivity.RL_begin_shake.setVisibility(View.VISIBLE);
                    mActivity.RL_middle_shake.setVisibility(View.GONE);
                    mActivity.RL_Finaly_shake.setVisibility(View.VISIBLE);
                    break;
            }
        }
    }
